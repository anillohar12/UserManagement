package com.anillohar.usermanagement.Rest;

import com.anillohar.usermanagement.Service.UserManagementService;
...
public class RestController {
    ...
    public ResponseEntity<String> activateAccount(
            @RequestBody ActivateAccount acc) {

        boolean isActivated =
                service.activateUserAcc(acc);
    ...
    public ResponseEntity<String> forgotPwd(
            @PathVariable String email) {

        String status =
                service.forgotPwd(email);
